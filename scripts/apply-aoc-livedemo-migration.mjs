#!/usr/bin/env node
/**
 * /aoc/livedemo · apply 0017_aoc_livedemo_submissions.sql to Supabase.
 *
 * Usage: node --env-file=.env.local scripts/apply-aoc-livedemo-migration.mjs
 *
...
const sqlPath = path.resolve("supabase/migrations/0017_aoc_livedemo_submissions.sql");
