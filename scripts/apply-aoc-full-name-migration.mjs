#!/usr/bin/env node
/**
 * AOC · apply 0012_aoc_waitlist_full_name.sql to Supabase.
 *
 * Usage: node --env-file=.env.local scripts/apply-aoc-full-name-migration.mjs
 *
...
const sqlPath = path.resolve("supabase/migrations/0012_aoc_waitlist_full_name.sql");
